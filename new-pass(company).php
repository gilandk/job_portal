...
<body class="hold-transition login-page gradientbg1">
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">Enter New Password (Candidate)</p>

            <form id="changePassword" action="newpass(company).php" method="post">

                <input type="hidden" class="form-control" id="email" name="email" value="<?php echo $_GET['mail']; ?>">

                <div class="form-group has-feedback">
                    <input id="password" class="form-control" type="password" name="password" autocomplete="off" placeholder="Password" required>
                </div>

                <div class="form-group has-feedback">
                    <input id="cpassword" class="form-control" type="password" autocomplete="off" placeholder="Confirm Password" required>
                </div>

                <div class="col-md-6">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" name="send">
                        Change Password
                    </button>
                </div>
    ...
    ?>
        <div>
            <p class="text-center">Invalid Email/Password! Try Again!
            </p>
        </div>
    <?php
