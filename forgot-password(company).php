...
<body class="hold-transition login-page gradientbg1">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg">Forgot Password (Employer)</p>

      <form method="post" action="fp_send(company).php">
        <div class="form-group has-feedback">
          <input type="email" class="form-control" id="email" name="email" placeholder="Enter you're Email">
