...
<body class="hold-transition login-page gradientbg1">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg">Reset Code</p>

      <form method="post" action="verify(company).php">
        <div class="form-group has-feedback">
        <input type="hidden" class="form-control" id="email" name="email" value="<?php echo $_GET['mail'];?>">
          <input type="text" class="form-control" id="code" name="code" placeholder="6-Digit code">
        </div>
        <!-- /.col -->
        <div class="col-md-6">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="verify">
            Verify
          </button>
      </form>
    </div>
