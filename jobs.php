                  ...
                  <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                    <li class="treeview menu-open">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="" class="citySearch" data-target="Ortigas"><i class="fa fa-circle-o text-yellow"></i>Ortigas</a></li>
                        <li><a href="" class="citySearch" data-target="Metro Manila"><i class="fa fa-circle-o text-yellow"></i>Manila</a></li>
                        <li><a href="" class="citySearch" data-target="Quezon City"><i class="fa fa-circle-o text-yellow"></i>Quezon City</a></li>
                        <li><a href="" class="citySearch" data-target="Makati"><i class="fa fa-circle-o text-yellow"></i>Makati</a></li>
                      </ul>
                    </li>
                    <li class="treeview menu-open">
                      <a href="#"><i class="fa fa-plane text-red"></i> Experience <span class="pull-right"><i class="fa fa-angle-down pull-right"></i></span></a>
                      <ul class="treeview-menu">
                        <li><a href="" class="experienceSearch" data-target='0'><i class="fa fa-circle-o text-yellow"></i> > No Experience</a></li>
