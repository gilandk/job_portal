...
if (isset($_POST)) {
	...
	$sql = "UPDATE company SET companyname='$companyname', website='$website', city='$city', state='$state', country='$country', contactno='$contactno', aboutme='$aboutme', mission='$mission', vision='$vision' ";
